...
class MainActivityTest : TestCase() {
    private var activityController: ActivityController<MainActivity>? = null
     var mockHolder: TodoItemsHolder? = null
    @Before
    fun setup() {
        ...
        Mockito.`when`(mockHolder?.currentItems).thenReturn(ArrayList())
    ...
    fun when_holderSaysNoItems_then_recyclerViewShowsZeroItems() {
        // setup
        Mockito.`when`(mockHolder!!.currentItems)
